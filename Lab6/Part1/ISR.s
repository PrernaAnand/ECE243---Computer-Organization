...
/* Configure the KEY pushbuttons port to generate interrupts */
                LDR     R0, =0xFF200050
                MOV     R1, #0xF
                STR     R1, [R0, #0x8]   //Enables interrupt

/* Enable IRQ interrupts in the ARM processor */
                MOV     R0, #0b01010010
                MSR     CPSR_c, R0       //copies contents of r0 into CPSR_c
IDLE:                                    
...
KEY_ISR:    
         LDR R0, =0xFF200050
         LDR R1, [R0, #0xC]
         STR R1, [R0, #0xC]   //Write to edge capture to disable it
         LDR R0, =KEY_HOLD
         LDR R2, [R0]
         EOR R1, R2, R1       //Toggles to flip it - This way while checking you get a 0
         STR R1, [R0]         //Reset key value

         LDR R0, =0xFF200020  //HEX base Address
         MOV R2, #0
...
END_KEY_ISR: STR R2, [R0]     //display in HEX
             BX LR
